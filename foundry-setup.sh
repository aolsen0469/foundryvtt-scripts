...
mkdir -p ${DATA_PATH}/Data/player-assets/art/{tokens,icons}
mkdir -p ${DATA_PATH}/Data/dm-assets/art/{tokens,images}
mkdir -p ${DATA_PATH}/Data/dm-assets/music/{tension,environment,combat}
mkdir -p ${DATA_PATH}/Data/dm-assets/sounds
mkdir -p ${DATA_PATH}/Data/dm-assets/art/{tokens,images,maps}
mkdir -p ${APP_PATH}
